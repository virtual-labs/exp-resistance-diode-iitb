...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(diode, new Chemistry.Point(1000, 500), 407 * 0.35, 1725 * 0.35, canvas);
    sq.name = 'Diode';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(milliammeter, new Chemistry.Point(1600, 400), 755 * 0.5, 686 * 0.5, canvas);
    sq.name = 'Milliammeter';
    scene.add(sq);
    var sq = new Chemistry.Custome_image(voltmeter, new Chemistry.Point(350, 400), 756 * 0.5, 686 * 0.5, canvas);
    sq.name = 'Voltmeter';
    scene.add(sq);
}
...
function a1_load_questions() { }
{
    ...
    question.push({
        srno: 2,
        question: "Select <span style='color: #018fc3'> Milliammeter </span>",
        ans: 'Milliammeter',
        hint: [
            'Has positive and negative connection',
            'Has a display',
            'Has positive and negative connection',
        ],
    });
...
function load_higlighted_images() {
    ...
    a1_labels = [
        new Chemistry.Geo_Text('Diode', new Chemistry.Point(850, 260), canvas),
        new Chemistry.Geo_Text('Milliammeter', new Chemistry.Point(1530, 170), canvas),
        new Chemistry.Geo_Text('Voltmeter', new Chemistry.Point(280, 170), canvas),
    ];
    a1_labels[0].font = '30%';
    a1_labels[1].font = '30%';
    a1_labels[2].font = '30%';
